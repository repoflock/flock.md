...
Spec changes are tracked in [CHANGELOG.md](CHANGELOG.md). There is no separate roadmap
while the spec is a `0.x` draft.

## Status Labels

Default vocabulary from [spec/SPEC.md §2.3](spec/SPEC.md): `Design` · `Building` ·
`Done <date>` · `Parked`.
